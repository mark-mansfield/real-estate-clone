...
import DesktopNavigation from '../stateful/DesktopNaviagtion';
const HeaderToolBar = () => {
  return (
    <div className="header__toolbar">
      <div className="header__toolbar-inner">
        <button type="button" className="header__mobile-nav-toggle">
          <span className="header__sr-only mobile-inner">Navigation</span>
          <span className="header__mobile-hamburger"></span>
        </button>
        <a className="header__logo" href="//www.domain.com.au/" title="Domain homepage">
